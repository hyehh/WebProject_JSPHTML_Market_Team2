...
public class BSsearchQnAListCommand implements BCommand {
...
//		int totalPage = total/rowSize + (total%rowSize==0?0:1);
		...
		// (2 * 10) - ( 10 - 1) = 20 - 9 = 11
		BFrontController.from = (pg * rowSize) - (rowSize - 1); // (1*10)-(10-1)=10-9=1 //from
...
//						((1-1) / 10 * 10) + 1
		...
		dtos = dao.searchQnA(searchtxt, BFrontController.from, BFrontController.to);
